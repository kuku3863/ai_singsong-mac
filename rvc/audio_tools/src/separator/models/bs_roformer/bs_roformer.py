...
class LinearAttention(Module):
    """
    Linear attention from https://arxiv.org/abs/2106.09681
    """
    @beartype
    def __init__(
        self,
...
class BSRoformer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        assert sum(freqs_per_bands) == freqs, f'freqs in bands must equal {freqs}, got {sum(freqs_per_bands)}'
    ...
    def forward(
        ...
        assert (not self.stereo and channels == 1) or (
            ...
            'stereo needs to be True for 2-channel audio, False for mono'
...
class MelBandRoformer(Module):
    ...
    def forward(
        ...
        assert (not self.stereo and channels == 1) or (
            self.stereo and channels == 2), \
            'stereo must be True for 2ch, False for mono'
        ...
        # index out frequencies for all bands
        ...
        # average masks for overlapped frequencies
